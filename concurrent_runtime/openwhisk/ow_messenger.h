/*
  Provides serverless platform dependent implementation of worker service message processing callbacks

  OpenWhisk action interface spec here: https://github.com/apache/openwhisk/blob/master/docs/actions-new.md
*/
